						...
						function doTheMagic(){
							let btnNext = document.querySelector('.prod-wrapper .next');
							let btnPrevious = document.querySelector('.prod-wrapper .previous');
							let overflow = document.querySelector('.prod-wrap');
							let block = document.querySelector('.prod-box');
							let allBlocks = document.querySelectorAll('.prod-box');
